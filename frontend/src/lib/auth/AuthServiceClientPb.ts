...
export class AuthClient {
  ...
  ): Promise<auth_pb.LoginReply>

  login(
    request: auth_pb.LoginRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: auth_pb.LoginReply) => void
  ): grpcWeb.ClientReadableStream<auth_pb.LoginReply>
  ...
  login(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/auth.Auth/Login',
        request,
        metadata || {},
  ...
  signUp(
    request: auth_pb.SignUpRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<auth_pb.SignUpReply>

  signUp(
    request: auth_pb.SignUpRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: auth_pb.SignUpReply) => void
  ): grpcWeb.ClientReadableStream<auth_pb.SignUpReply>
  ...
  signUp(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/auth.Auth/SignUp',
        request,
        metadata || {},
  ...
  logOut(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/auth.Auth/LogOut',
        request,
        metadata || {},
  ...
  me(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | null
  ): Promise<auth_pb.MeReply>

  me(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: auth_pb.MeReply) => void
  ): grpcWeb.ClientReadableStream<auth_pb.MeReply>
  ...
  setHealthRecord(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/auth.Auth/SetHealthRecord',
        request,
        metadata || {},
...
export class UserClient {
  ...
  setHealthRecord(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/auth.User/SetHealthRecord',
        request,
        metadata || {},
        this.methodDescriptorSetHealthRecord,
        callback
