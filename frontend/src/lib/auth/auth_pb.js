...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.auth.HealthRecordRequest.prototype.toObject = function (
    opt_includeInstance
  ) {
 ...
 * @return {!proto.auth.HealthRecordRequest}
 */
proto.auth.HealthRecordRequest.deserializeBinaryFromReader = function (
  msg,
  reader
) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.auth.HealthRecordRequest.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined
  ...
  proto.auth.SignUpReply.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        tokenInfo:
          (f = msg.getTokenInfo()) &&
          proto.auth.TokenInfo.toObject(includeInstance, f),
      }
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.auth.TokenInfo.deserializeBinaryFromReader
        )
...
proto.auth.SignUpReply.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.auth.TokenInfo.serializeBinaryToWriter)
  }
}
  ...
  proto.auth.MeReply.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        user:
          (f = msg.getUser()) &&
          proto.auth.UserInfo.toObject(includeInstance, f),
      }
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(
          value,
          proto.auth.UserInfo.deserializeBinaryFromReader
        )
        msg.setUser(value)
        break
      default:
...
proto.auth.MeReply.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getUser()
  if (f != null) {
    writer.writeMessage(1, f, proto.auth.UserInfo.serializeBinaryToWriter)
  }
}
