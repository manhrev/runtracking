...
export class NotificationClient {
  ...
  methodDescriptorCheckIfExistOrSaveExpoPushToken =
  ...
  removeExpoPushToken(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/notification.Notification/RemoveExpoPushToken',
        request,
        metadata || {},
  ...
  listNotificationInfo(
    request: notification_pb.ListNotificationInfoRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<notification_pb.ListNotificationInfoReply>
  ...
  listNotificationInfo(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: notification_pb.ListNotificationInfoReply
    ) => void
  ): grpcWeb.ClientReadableStream<notification_pb.ListNotificationInfoReply>
  ...
  listNotificationInfo(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/notification.Notification/ListNotificationInfo',
        request,
        metadata || {},
  ...
  deleteNotificationInfo(
    request: notification_pb.IdRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<notification_pb.IdReply>

  deleteNotificationInfo(
    request: notification_pb.IdRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: notification_pb.IdReply) => void
  ): grpcWeb.ClientReadableStream<notification_pb.IdReply>
  ...
  deleteNotificationInfo(
    ...
    callback?: (
      err: grpcWeb.RpcError,
      response: notification_pb.IdReply
    ) => void
  ) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/notification.Notification/DeleteNotificationInfo',
        request,
        metadata || {},
  ...
  updateNotificationInfo(
    request: notification_pb.UpdateNotificationInfoRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<notification_pb.UpdateNotificationInfoReply>
  ...
  updateNotificationInfo(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: notification_pb.UpdateNotificationInfoReply
    ) => void
  ): grpcWeb.ClientReadableStream<notification_pb.UpdateNotificationInfoReply>
  ...
  updateNotificationInfo(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/notification.Notification/UpdateNotificationInfo',
        request,
        metadata || {},
