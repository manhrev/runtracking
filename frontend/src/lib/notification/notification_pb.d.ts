...
export class UpdateNotificationInfoRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: UpdateNotificationInfoRequest
  ): UpdateNotificationInfoRequest.AsObject
...
export class UpdateNotificationInfoReply extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UpdateNotificationInfoReply
  ): UpdateNotificationInfoReply.AsObject
  static serializeBinaryToWriter(
...
export class ExpoPushTokenRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ExpoPushTokenRequest
  ): ExpoPushTokenRequest.AsObject
  static serializeBinaryToWriter(
...
export class ListNotificationInfoReply extends jspb.Message {
  ...
  setNotificationListList(
    value: Array<NotificationInfo>
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListNotificationInfoReply
  ): ListNotificationInfoReply.AsObject
  static serializeBinaryToWriter(
...
export class ListNotificationInfoRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListNotificationInfoRequest
  ): ListNotificationInfoRequest.AsObject
  static serializeBinaryToWriter(
