...
export class ActivityClient {
  ...
  ): Promise<activity_pb.CreateActivityInfoReply>
  ...
  createActivityInfo(
    ...
    callback: (
      ...
      response: activity_pb.CreateActivityInfoReply
    ) => void
  ): grpcWeb.ClientReadableStream<activity_pb.CreateActivityInfoReply>
  ...
  createActivityInfo(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/activity.Activity/CreateActivityInfo',
        request,
        metadata || {},
  ...
  listActivityInfo(
    request: activity_pb.ListActivityInfoRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<activity_pb.ListActivityInfoReply>
  ...
  listActivityInfo(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: activity_pb.ListActivityInfoReply
    ) => void
  ): grpcWeb.ClientReadableStream<activity_pb.ListActivityInfoReply>
  ...
  listActivityInfo(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/activity.Activity/ListActivityInfo',
        request,
        metadata || {},
  ...
  deleteActivityInfo(
    request: activity_pb.DeleteActivityInfoRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<activity_pb.DeleteActivityInfoReply>
  ...
  deleteActivityInfo(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: activity_pb.DeleteActivityInfoReply
    ) => void
  ): grpcWeb.ClientReadableStream<activity_pb.DeleteActivityInfoReply>
  ...
  deleteActivityInfo(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/activity.Activity/DeleteActivityInfo',
        request,
        metadata || {},
  ...
  getActivityStatistic(
    request: activity_pb.GetActivityStatisticRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<activity_pb.GetActivityStatisticReply>
  ...
  getActivityStatistic(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: activity_pb.GetActivityStatisticReply
    ) => void
  ): grpcWeb.ClientReadableStream<activity_pb.GetActivityStatisticReply>
  ...
  getActivityStatistic(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/activity.Activity/GetActivityStatistic',
        request,
        metadata || {},
  ...
  commitActivity(
    request: activity_pb.CommitActivityRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<activity_pb.CommitActivityReply>
  ...
  commitActivity(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: activity_pb.CommitActivityReply
    ) => void
  ): grpcWeb.ClientReadableStream<activity_pb.CommitActivityReply>
  ...
  commitActivity(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/activity.Activity/CommitActivity',
        request,
        metadata || {},
