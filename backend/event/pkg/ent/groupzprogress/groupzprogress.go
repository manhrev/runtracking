...
const (
	// Label holds the string label denoting the groupzprogress type in the database.
	Label = "groupz_progress"
	...
	EdgeMember = "member"
	// Table holds the table name of the groupzprogress in the database.
	Table = "groupz_progresses"
	// SubEventTable is the table that holds the sub_event relation/edge.
	SubEventTable = "groupz_progresses"
	...
	MemberColumn = "groupz_progress_member"
)

// Columns holds all SQL columns for groupzprogress fields.
var Columns = []string{
	FieldID,
	FieldGroupID,
	FieldProgress,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "groupz_progresses"
...
// Order defines the ordering method for the GroupzProgress queries.
