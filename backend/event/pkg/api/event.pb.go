...
var file_api_event_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x54, 0x79, 0x70, 0x65, 0x22, 0xbe,
	...
	0x28, 0x0d, 0x52, 0x0b, 0x6e, 0x75, 0x6d, 0x4f, 0x66, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22,
	...
	0x6f, 0x6d, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0xe6, 0x03, 0x0a,
	...
	0x61, 0x72, 0x63, 0x68, 0x22, 0x64, 0x0a, 0x06, 0x53, 0x6f, 0x72, 0x74, 0x42, 0x79, 0x12, 0x17,
	...
	0x42, 0x59, 0x5f, 0x4e, 0x41, 0x4d, 0x45, 0x10, 0x01, 0x12, 0x14, 0x0a, 0x10, 0x53, 0x4f, 0x52,
	0x54, 0x5f, 0x42, 0x59, 0x5f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x41, 0x54, 0x10, 0x02, 0x12,
	0x19, 0x0a, 0x15, 0x53, 0x4f, 0x52, 0x54, 0x5f, 0x42, 0x59, 0x5f, 0x4e, 0x55, 0x4d, 0x5f, 0x4f,
	0x46, 0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x53, 0x10, 0x03, 0x22, 0x59, 0x0a, 0x0a, 0x56, 0x69,
	...
	0x54, 0x59, 0x5f, 0x47, 0x4c, 0x4f, 0x42, 0x41, 0x4c, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x56,
	0x49, 0x53, 0x49, 0x42, 0x49, 0x4c, 0x49, 0x54, 0x59, 0x5f, 0x4e, 0x4f, 0x5f, 0x47, 0x4c, 0x4f,
	0x42, 0x41, 0x4c, 0x10, 0x02, 0x22, 0x53, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x76, 0x65,
...
var file_api_event_proto_depIdxs = []int32{
	...
	10, // 7: event.CreateEventRequest.sub_events:type_name -> event.CreateSubEvent
	33, // 8: event.CreateEventRequest.start_at:type_name -> google.protobuf.Timestamp
	1,  // 9: event.CreateSubEvent.rule:type_name -> event.Rule
	33, // 10: event.CreateSubEvent.start_at:type_name -> google.protobuf.Timestamp
	33, // 11: event.CreateSubEvent.end_at:type_name -> google.protobuf.Timestamp
	0,  // 12: event.CreateSubEvent.activity_type:type_name -> event.ActivityType
	4,  // 13: event.GroupInEvent.status:type_name -> event.GroupStatus
	17, // 14: event.ListGroupsInEventReply.groups:type_name -> event.GroupInEvent
	10, // 15: event.AddSubEventToEventRequest.sub_event:type_name -> event.CreateSubEvent
	5,  // 16: event.ListEventsRequest.sort_by:type_name -> event.ListEventsRequest.SortBy
	6,  // 17: event.ListEventsRequest.visibility:type_name -> event.ListEventsRequest.Visibility
	8,  // 18: event.ListEventsReply.events:type_name -> event.EventDetail
	7,  // 19: event.ListSubEventsReply.sub_events:type_name -> event.SubEvent
	31, // 20: event.SubEventProgress.group_progress:type_name -> event.GroupProgressInSubEvent
	30, // 21: event.ListGroupProgressInEventReply.sub_event_progress:type_name -> event.SubEventProgress
	9,  // 22: event.Event.CreateEvent:input_type -> event.CreateEventRequest
	12, // 23: event.Event.UpdateEventInfo:input_type -> event.UpdateEventInfoRequest
	14, // 24: event.Event.JoinEvent:input_type -> event.JoinEventRequest
	19, // 25: event.Event.ApproveJoinEvent:input_type -> event.ApproveJoinEventRequest
	21, // 26: event.Event.AddSubEventToEvent:input_type -> event.AddSubEventToEventRequest
	23, // 27: event.Event.RemoveSubEventFromEvent:input_type -> event.RemoveSubEventFromEventRequest
	25, // 28: event.Event.ListEvents:input_type -> event.ListEventsRequest
	27, // 29: event.Event.ListSubEvents:input_type -> event.ListSubEventsRequest
	16, // 30: event.Event.ListGroupsInEvent:input_type -> event.ListGroupsInEventRequest
	29, // 31: event.Event.ListGroupProgressInEvent:input_type -> event.ListGroupProgressInEventRequest
	11, // 32: event.Event.CreateEvent:output_type -> event.CreateEventReply
	13, // 33: event.Event.UpdateEventInfo:output_type -> event.UpdateEventInfoReply
	15, // 34: event.Event.JoinEvent:output_type -> event.JoinEventReply
	20, // 35: event.Event.ApproveJoinEvent:output_type -> event.ApproveJoinEventReply
	22, // 36: event.Event.AddSubEventToEvent:output_type -> event.AddSubEventToEventReply
	24, // 37: event.Event.RemoveSubEventFromEvent:output_type -> event.RemoveSubEventFromEventReply
	26, // 38: event.Event.ListEvents:output_type -> event.ListEventsReply
	28, // 39: event.Event.ListSubEvents:output_type -> event.ListSubEventsReply
	18, // 40: event.Event.ListGroupsInEvent:output_type -> event.ListGroupsInEventReply
	32, // 41: event.Event.ListGroupProgressInEvent:output_type -> event.ListGroupProgressInEventReply
