...
var file_api_event_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0xca, 0x02, 0x0a,
	...
	0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x73, 0x47, 0x6c, 0x6f,
	0x62, 0x61, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x47, 0x6c, 0x6f,
	0x62, 0x61, 0x6c, 0x22, 0x64, 0x0a, 0x06, 0x53, 0x6f, 0x72, 0x74, 0x42, 0x79, 0x12, 0x17, 0x0a,
...
var file_api_event_proto_depIdxs = []int32{
	...
	32, // 5: event.EventDetail.start_at:type_name -> google.protobuf.Timestamp
	32, // 6: event.EventDetail.end_at:type_name -> google.protobuf.Timestamp
	9,  // 7: event.CreateEventRequest.sub_events:type_name -> event.CreateSubEvent
	32, // 8: event.CreateEventRequest.start_at:type_name -> google.protobuf.Timestamp
	1,  // 9: event.CreateSubEvent.rule:type_name -> event.Rule
	32, // 10: event.CreateSubEvent.start_at:type_name -> google.protobuf.Timestamp
	32, // 11: event.CreateSubEvent.end_at:type_name -> google.protobuf.Timestamp
	...
	16, // 14: event.ListGroupsInEventReply.groups:type_name -> event.GroupInEvent
	9,  // 15: event.AddSubEventToEventRequest.sub_event:type_name -> event.CreateSubEvent
	5,  // 16: event.ListEventsRequest.sort_by:type_name -> event.ListEventsRequest.SortBy
	7,  // 17: event.ListEventsReply.events:type_name -> event.EventDetail
	6,  // 18: event.ListSubEventsReply.sub_events:type_name -> event.SubEvent
	30, // 19: event.SubEventProgress.group_progress:type_name -> event.GroupProgressInSubEvent
	29, // 20: event.ListGroupProgressInEventReply.sub_event_progress:type_name -> event.SubEventProgress
	8,  // 21: event.Event.CreateEvent:input_type -> event.CreateEventRequest
	11, // 22: event.Event.UpdateEventInfo:input_type -> event.UpdateEventInfoRequest
	13, // 23: event.Event.JoinEvent:input_type -> event.JoinEventRequest
	18, // 24: event.Event.ApproveJoinEvent:input_type -> event.ApproveJoinEventRequest
	20, // 25: event.Event.AddSubEventToEvent:input_type -> event.AddSubEventToEventRequest
	22, // 26: event.Event.RemoveSubEventFromEvent:input_type -> event.RemoveSubEventFromEventRequest
	24, // 27: event.Event.ListEvents:input_type -> event.ListEventsRequest
	26, // 28: event.Event.ListSubEvents:input_type -> event.ListSubEventsRequest
	15, // 29: event.Event.ListGroupsInEvent:input_type -> event.ListGroupsInEventRequest
	28, // 30: event.Event.ListGroupProgressInEvent:input_type -> event.ListGroupProgressInEventRequest
	10, // 31: event.Event.CreateEvent:output_type -> event.CreateEventReply
	12, // 32: event.Event.UpdateEventInfo:output_type -> event.UpdateEventInfoReply
	14, // 33: event.Event.JoinEvent:output_type -> event.JoinEventReply
	19, // 34: event.Event.ApproveJoinEvent:output_type -> event.ApproveJoinEventReply
	21, // 35: event.Event.AddSubEventToEvent:output_type -> event.AddSubEventToEventReply
	23, // 36: event.Event.RemoveSubEventFromEvent:output_type -> event.RemoveSubEventFromEventReply
	25, // 37: event.Event.ListEvents:output_type -> event.ListEventsReply
	27, // 38: event.Event.ListSubEvents:output_type -> event.ListSubEventsReply
	17, // 39: event.Event.ListGroupsInEvent:output_type -> event.ListGroupsInEventReply
	31, // 40: event.Event.ListGroupProgressInEvent:output_type -> event.ListGroupProgressInEventReply
