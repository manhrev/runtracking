...
func (uc *UserCreate) SetUserSettingID(id int64) *UserCreate {
	uc.mutation.SetUserSettingID(id)
	return uc
}

// SetNillableUserSettingID sets the "user_setting" edge to the UserSetting entity by ID if the given value is not nil.
func (uc *UserCreate) SetNillableUserSettingID(id *int64) *UserCreate {
	if id != nil {
		uc = uc.SetUserSettingID(*id)
	}
	return uc
}

// SetUserSetting sets the "user_setting" edge to the UserSetting entity.
func (uc *UserCreate) SetUserSetting(u *UserSetting) *UserCreate {
	return uc.SetUserSettingID(u.ID)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.UserSettingIDs(); len(nodes) > 0 {
