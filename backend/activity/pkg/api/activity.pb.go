...
var file_api_activity_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x2a, 0x7e, 0x0a, 0x0c, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69,
	...
	0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x10, 0x03, 0x32, 0xd4,
	...
	0x69, 0x76, 0x69, 0x74, 0x79, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x12, 0x50, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x41, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x12, 0x1f, 0x2e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79,
	0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x52,
	...
	0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_api_activity_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_api_activity_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_activity_proto_goTypes = []interface{}{
	...
	(GetActivityStatisticRequest_GroupBy)(0), // 3: activity.GetActivityStatisticRequest.GroupBy
	(*TrackPoint)(nil),                       // 4: activity.TrackPoint
	(*ActivityInfo)(nil),                     // 5: activity.ActivityInfo
	(*CreateActivityInfoRequest)(nil),        // 6: activity.CreateActivityInfoRequest
	(*CreateActivityInfoReply)(nil),          // 7: activity.CreateActivityInfoReply
	(*ListActivityInfoRequest)(nil),          // 8: activity.ListActivityInfoRequest
	(*ListActivityInfoReply)(nil),            // 9: activity.ListActivityInfoReply
	(*DeleteActivityInfoRequest)(nil),        // 10: activity.DeleteActivityInfoRequest
	(*DeleteActivityInfoReply)(nil),          // 11: activity.DeleteActivityInfoReply
	(*GetActivityStatisticRequest)(nil),      // 12: activity.GetActivityStatisticRequest
	(*GetActivityStatisticReply)(nil),        // 13: activity.GetActivityStatisticReply
	(*ActivityStatisticData)(nil),            // 14: activity.ActivityStatisticData
	(*CommitActivityRequest)(nil),            // 15: activity.CommitActivityRequest
	(*CommitActivityReply)(nil),              // 16: activity.CommitActivityReply
	(*timestamppb.Timestamp)(nil),            // 17: google.protobuf.Timestamp
}
var file_api_activity_proto_depIdxs = []int32{
	17, // 0: activity.TrackPoint.created_at:type_name -> google.protobuf.Timestamp
	0,  // 1: activity.ActivityInfo.type:type_name -> activity.ActivityType
	17, // 2: activity.ActivityInfo.start_time:type_name -> google.protobuf.Timestamp
	17, // 3: activity.ActivityInfo.end_time:type_name -> google.protobuf.Timestamp
	4,  // 4: activity.ActivityInfo.route:type_name -> activity.TrackPoint
	2,  // 5: activity.ActivityInfo.commit_type:type_name -> activity.CommitType
	5,  // 6: activity.CreateActivityInfoRequest.activity_info:type_name -> activity.ActivityInfo
	...
	17, // 9: activity.ListActivityInfoRequest.from:type_name -> google.protobuf.Timestamp
	17, // 10: activity.ListActivityInfoRequest.to:type_name -> google.protobuf.Timestamp
	5,  // 11: activity.ListActivityInfoReply.activity_list:type_name -> activity.ActivityInfo
	0,  // 12: activity.GetActivityStatisticRequest.type:type_name -> activity.ActivityType
	17, // 13: activity.GetActivityStatisticRequest.from:type_name -> google.protobuf.Timestamp
	17, // 14: activity.GetActivityStatisticRequest.to:type_name -> google.protobuf.Timestamp
	3,  // 15: activity.GetActivityStatisticRequest.group_by:type_name -> activity.GetActivityStatisticRequest.GroupBy
	14, // 16: activity.GetActivityStatisticReply.data:type_name -> activity.ActivityStatisticData
	17, // 17: activity.ActivityStatisticData.datetime:type_name -> google.protobuf.Timestamp
	2,  // 18: activity.CommitActivityRequest.commit_type:type_name -> activity.CommitType
	6,  // 19: activity.Activity.CreateActivityInfo:input_type -> activity.CreateActivityInfoRequest
	8,  // 20: activity.Activity.ListActivityInfo:input_type -> activity.ListActivityInfoRequest
	10, // 21: activity.Activity.DeleteActivityInfo:input_type -> activity.DeleteActivityInfoRequest
	12, // 22: activity.Activity.GetActivityStatistic:input_type -> activity.GetActivityStatisticRequest
	15, // 23: activity.Activity.CommitActivity:input_type -> activity.CommitActivityRequest
	7,  // 24: activity.Activity.CreateActivityInfo:output_type -> activity.CreateActivityInfoReply
	9,  // 25: activity.Activity.ListActivityInfo:output_type -> activity.ListActivityInfoReply
	11, // 26: activity.Activity.DeleteActivityInfo:output_type -> activity.DeleteActivityInfoReply
	13, // 27: activity.Activity.GetActivityStatistic:output_type -> activity.GetActivityStatisticReply
	16, // 28: activity.Activity.CommitActivity:output_type -> activity.CommitActivityReply
