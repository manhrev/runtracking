...
func (ou *ObjectUpdate) SetValue(f float32) *ObjectUpdate {
...
func (ou *ObjectUpdate) AddValue(f float32) *ObjectUpdate {
...
func (ou *ObjectUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ou.mutation.Value(); ok {
		_spec.SetField(object.FieldValue, field.TypeFloat32, value)
	}
	if value, ok := ou.mutation.AddedValue(); ok {
		_spec.AddField(object.FieldValue, field.TypeFloat32, value)
	}
...
// SetValue sets the "value" field.
func (ouo *ObjectUpdateOne) SetValue(f float32) *ObjectUpdateOne {
...
// AddValue adds f to the "value" field.
func (ouo *ObjectUpdateOne) AddValue(f float32) *ObjectUpdateOne {
