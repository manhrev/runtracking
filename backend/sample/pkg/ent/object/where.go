...
import (
	...
	"github.com/manhrev/runtracking/backend/sample/pkg/ent/predicate"
)

// ID filters vertices based on their ID field.
func ID(id int64) predicate.Object {
...
func IDEQ(id int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func IDIn(ids ...int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func IDGTE(id int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func IDLT(id int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func IDLTE(id int64) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func Value(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func ValueEQ(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldValue), v))
	})
}
...
func ValueNEQ(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func ValueIn(vs ...float32) predicate.Object {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ValueNotIn(vs ...float32) predicate.Object {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ValueGT(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func ValueGTE(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func ValueLT(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
...
func ValueLTE(v float32) predicate.Object {
	return predicate.Object(func(s *sql.Selector) {
