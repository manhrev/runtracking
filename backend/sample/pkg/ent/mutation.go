...
func (m *ObjectMutation) SetValue(f float32) {
	m.value = &f
	m.addvalue = nil
}

// Value returns the value of the "value" field in the mutation.
func (m *ObjectMutation) Value() (r float32, exists bool) {
	v := m.value
	if v == nil {
		return
	}
...
// OldValue returns the old "value" field's value of the Object entity.
// If the Object object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ObjectMutation) OldValue(ctx context.Context) (v float32, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ObjectMutation) AddValue(f float32) {
	if m.addvalue != nil {
		*m.addvalue += f
	} else {
		m.addvalue = &f
...
func (m *ObjectMutation) AddedValue() (r float32, exists bool) {
	v := m.addvalue
	if v == nil {
		return
	}
...
func (m *ObjectMutation) ResetValue() {
	m.value = nil
	m.addvalue = nil
}
...
func (m *ObjectMutation) Fields() []string {
	...
	if m.value != nil {
		fields = append(fields, object.FieldValue)
	}
	return fields
}
